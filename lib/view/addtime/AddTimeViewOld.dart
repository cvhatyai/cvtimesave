...
class AddTimeViewOld extends StatefulWidget {
  const AddTimeViewOld({Key? key}) : super(key: key);

  @override
  _AddTimeViewOldState createState() => _AddTimeViewOldState();
}

class _AddTimeViewOldState extends State<AddTimeViewOld> {
  int indexSelected = 0;
